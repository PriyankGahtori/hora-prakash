...
// North Indian chart: 12 triangles tiling a unit square, all meeting at center (1/2,1/2).
// House 1 = top center, houses go clockwise.
// Corner houses (2,5,8,11) = outer-edge triangles; others = triangles to center.
const C = 1/2  // center
const NI_POLYS = {
  1:  [[1/3,0],[2/3,0],[C,C]],
  2:  [[2/3,0],[1,0],[1,1/3]],
